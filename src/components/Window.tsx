...
import HeavensSmileGallery from '@/components/applications/HeavensSmileGallery'
import CatherinesSuitcase from '@/components/applications/CatherinesSuitcase'
import LostFoundGames from '@/components/applications/LostFoundGames'
import TransmittedConsciousness from '@/components/applications/TransmittedConsciousness'
...
export default function Window({ 
  ...
  const renderApplicationComponent = () => {
    ...
    switch (window.component) {
      ...
      case 'HeavensSmileGallery':
        return <HeavensSmileGallery windowId={window.id} />
      case 'CatherinesSuitcase':
        return <CatherinesSuitcase windowId={window.id} />
      case 'LostFoundGames':
        return <LostFoundGames windowId={window.id} />
      case 'TransmittedConsciousness':
        return <TransmittedConsciousness windowId={window.id} />
      default:
        return (
    ...
    >
      <div className="window-header">
        <div className="window-title">
          ...
          {window.component === 'TransmittedConsciousness' && (
...
function getWindowIcon(component: string): string {
