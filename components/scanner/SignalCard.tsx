...
export default function SignalCard({ card, href, index }: SignalCardProps) {
  ...
  return (
    ...
    >
      <Link
        href={href}
        className="group relative flex h-full flex-col overflow-hidden border-brutal bg-white p-6 text-left shadow-brutal transition-all duration-200 hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-brutal-hover focus:outline-none focus-visible:ring-4 focus-visible:ring-black"
      >
