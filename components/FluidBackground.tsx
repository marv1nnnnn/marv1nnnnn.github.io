...
export default function FluidBackground() {
  return (
    <div className="fixed inset-0 w-full h-full pointer-events-none overflow-hidden">
      ...
      <div className="absolute inset-[-50%] w-[200%] h-[200%] opacity-[0.3] mix-blend-screen"
           style={{
      ...
      <div className="absolute inset-[-50%] w-[200%] h-[200%] opacity-[0.25] mix-blend-color-dodge"
           style={{
